...
public class Exercise_3_13 {
	public static void main(String[] args){
		// this program is made to compute taxes for all filing statuses
		
		Scanner input = new Scanner(System.in);
		
		System.out.print("(0-single filer, 1-married jointly or quialifying widow(er);, 2-married separately, 3-head of household) Enter the filing status: ");
		...
		if (status == 0){	// compute tzx for single filers
			if(income <= 8350)
				tax = income * 0.10;
		...
		else if(status == 1){	// compute tax for married filing jointly or quialifying widow(er)
			if(income <= 16700)
				tax = income * 0.10;
			...
			if(income <= 8350)
				...
				tax = 8350 * 0.10 + (33950 - 8300) * 0.15 + (68525 - 33950) * 0.25 + (income - 68525) * 0.28;
			else if(income >= 186475)
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (income - 104425) * 0.33;
			else
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (372950 - 104425) * 0.33 + (income - 186475) * 0.35;
		}
